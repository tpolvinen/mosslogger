...
float measurementVoltage00 = 0.0, measurementVoltage01 = 0.0, measurementVoltage02 = 0.0, measurementVoltage03 = 0.0;
float measurementVoltage10 = 0.0, measurementVoltage11 = 0.0, measurementVoltage12 = 0.0, measurementVoltage13 = 0.0;
float measurementVoltage20 = 0.0, measurementVoltage21 = 0.0, measurementVoltage22 = 0.0, measurementVoltage23 = 0.0;
float measurementVoltage30 = 0.0, measurementVoltage31 = 0.0, measurementVoltage32 = 0.0, measurementVoltage33 = 0.0;

  float voltages[] = {
    measurementVoltage00,
    measurementVoltage01,
    measurementVoltage02,
    measurementVoltage03,
    measurementVoltage10,
    measurementVoltage11,
    measurementVoltage12,
    measurementVoltage13,
    measurementVoltage20,
    measurementVoltage21,
    measurementVoltage22,
    measurementVoltage23,
    measurementVoltage30,
    measurementVoltage31,
    measurementVoltage32,
    measurementVoltage33
  };
...
char logMsg[100];
char measurementfileHeader[116]; // space for YYYY-MM-DDThh:mm:ss,0-0,V,0-1,V,0-2,V,0-3,V,1-0,V,1-1,V,1-2,V,1-3,V,2-0,V,2-1,V,2-2,V,2-3,V,3-0,V,3-1,V,3-2,V,3-3,V, plus the null char terminator
...
void calculateVoltages() {
  ...
  // Make sure that the arrays below have equal number of items!

  long measuremenRoundAverages[] = {
    measurementRoundAverage00,
    measurementRoundAverage01,
    measurementRoundAverage02,
    measurementRoundAverage03,
    measurementRoundAverage10,
    measurementRoundAverage11,
    measurementRoundAverage12,
    measurementRoundAverage13,
    measurementRoundAverage20,
    measurementRoundAverage21,
    measurementRoundAverage22,
    measurementRoundAverage23,
    measurementRoundAverage30,
    measurementRoundAverage31,
    measurementRoundAverage32,
    measurementRoundAverage33
  };


  int arraySize = sizeof(measuremenRoundAverages) / sizeof(measuremenRoundAverages[0]);

  for (int x = 0; x < arraySize; x++) {
    Serial.print(measuremenRoundAverages[x]);
    voltages[x] = (measuremenRoundAverages[x] * 0.1875) / 1000;
    Serial.print("->");
    Serial.println(voltages[x]);
  }
...
void sd1write() {
  ...
  if (! (measurementfile1.print(measurementVoltage00)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage01)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage02)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage03)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage10)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage11)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage12)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage13)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage20)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage21)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage22)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage23)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage30)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage31)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.print(measurementVoltage32)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
  if (! (measurementfile1.print(",")) ) {
    sd1.errorExit("measurementfile1 writing");
  ...
  if (! (measurementfile1.println(measurementVoltage33)) ) {
    sd1.errorExit("measurementfile1 writing");
  }
...
void setup() {
  ...
  sprintf(measurementfileHeader, ("YYYY-MM-DDThh:mm:ss,0-0,V,0-1,V,0-2,V,0-3,V,1-0,V,1-1,V,1-2,V,1-3,V,2-0,V,2-1,V,2-2,V,2-3,V,3-0,V,3-1,V,3-2,V,3-3,V"));
